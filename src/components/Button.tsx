...
const Button = ({title,src,showOnSmallDevices}:Partial< ButtonType>) => (
    <button className={`rounded-full border-[coral]  bg-[coral] flex justify-center items-center px-7 py-3 text-lg   border leading-none w-fit h-fit ${showOnSmallDevices   && `max-sm:w-[32vh]  `}  `}>
        {title}
