...
const Contact = () => {
    ...
    emailjs.sendForm('service_yck9jnk', 'template_jzkk4lq', form.current!, 'xCMMKBfVq5Lv8nrGb')
      .then((result) => {
    ...
    <div>
      ...
      <section className="text-gray-600 body-font relative h-full top-28 ">
        <div className="absolute inset-0 bg-gray-300">
          ...
          <form className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md" onSubmit={sendEmail} ref={form}>
            <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Feedback</h2>
             <p className="leading-relaxed mb-5 text-gray-600">Write Us a Message</p>
            
            <label htmlFor="name" className="leading-7 text-sm bg-transparent">Name</label>
